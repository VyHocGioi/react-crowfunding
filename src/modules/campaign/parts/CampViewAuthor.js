    ...
    <div className="flex items-center gap-x-5">
      ...
      <div className="flex flex-col flex-1">
        <div className="flex items-center gap-x-4">
          <h3 className="text-lg font-medium">Saifu Islam</h3>
        ...
        <div className="flex items-center gap-x-3">
          <strong className="text-sm text-primary">02 Campaign</strong>
          <span className="block w-[6px] h-[6px] rounded-full bg-text3"></span>
          <span className="text-sm text-text-3 ">Dhaka, Bangladesh</span>
        </div>
      </div>
    </div>
  );
